...
<div id="wrapper">
	...
	<section class="section section-hero-page" style="--section-bg: var(--tj-color--bg-post);">
		<div class="tj-container">
			<div class="inner">
				<h1 class="title-page">What’s On</h1>
				
				<!-- Banner Desktop -->
				<img src="<?= TSBT_URI ?>/template-html/images/blog/banner-offers.png" alt="ALT TITLE" class="featured-image hide-sm hide-md">
	...
	<section class="section section-highlight" style="--section-bg: var(--tj-color--bg-post);">
		<div class="tj-container">

			<div class="section-head">
				<h3 class="title-section">Highlight</h3>
			</div>
			<div class="section-body">
				<?php $contents = [
					[
						...
						'title' => 'Coffee Revolution: New Innovations in Coffee Production and Flavor Take the World by Storm',
						...
						'date' => '28 JAN 2023',
						'category' => ['Lifestyle', 'Cat 1', 'Cat 2']
					],
					[
						'link' => get_home_url() . '/html/single-post',
						'thumb' => TSBT_URI . '/template-html/images/home/post-thumb-2.jpg',
						'title' => 'New Trend in the Coffee World: Young Consumers Lead the Movement for Sustainable Coffee',
												...
												<div class="inner">
													<div class="post-info">
														<div class="post-category">
															<?php foreach ($content['category'] as $cat) { ?>
																<span><?= $cat ?></span>
															<?php } ?>
														</div>
				
														<div class="post-date"><?= $content['date'] ?></div>
													</div>
	...
	<section class="section section-cta-body">
		<div class="tj-container">
			<div class="cta-body" style="--cta-bg: url('<?= TSBT_URI ?>/assets/images/cta-body-bg.jpg');">
				<div class="row row-cta">
					...
					<div class="col-12 col-lg-auto">
						<img src="<?= TSBT_URI ?>/template-html/images/blog/cta-body-image.png" alt="ALT TITLE" class="cta-image">
					</div>
				</div>
			</div>
		</div>
	...
	<section id="content" class="section section-posts-content">
		<div class="tj-container">
			<div class="section-body">
				...
				<div class="navigate-label">Latest News</div>
